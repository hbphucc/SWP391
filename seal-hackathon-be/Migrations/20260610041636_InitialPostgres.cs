        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    StudentType = table.Column<int>(type: "integer", nullable: true),
                    ...
                    PlainPassword = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    DeveloperRole = table.Column<int>(type: "integer", nullable: true),
                    ProgrammingLanguages = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Track = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: true),
                    Description = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxTeamsAdvancing = table.Column<int>(type: "integer", nullable: false),
                    SubmissionDeadline = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    EventId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JudgeAssignments_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    EliminationReason = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    EliminatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Teams_Rounds_CurrentRoundId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SlideUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JudgeId = table.Column<Guid>(type: "uuid", nullable: false),
                    CriteriaId = table.Column<Guid>(type: "uuid", nullable: false),
                    ScoreValue = table.Column<decimal>(type: "numeric(5,2)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JudgeAssignments_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Scores_SubmissionId_JudgeId_CriteriaId",
                table: "Scores",
