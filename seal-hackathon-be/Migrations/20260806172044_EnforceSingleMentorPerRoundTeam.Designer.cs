...
namespace SEAL.NET.Migrations
{
    ...
    [Migration("20260806172044_EnforceSingleMentorPerRoundTeam")]
    partial class EnforceSingleMentorPerRoundTeam
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationUserEvent", b =>
                {
                    ...
                    b.Property<Guid>("RegisteredMentorsId")
                        .HasColumnType("uuid");

                    b.HasKey("EventId", "RegisteredMentorsId");

                    b.HasIndex("RegisteredMentorsId");

                    b.ToTable("EventMentors", (string)null);
                });

            modelBuilder.Entity("ApplicationUserEvent1", b =>
                {
                    b.Property<Guid>("Event1EventId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("RegisteredJudgesId")
                        .HasColumnType("uuid");

                    b.HasKey("Event1EventId", "RegisteredJudgesId");

                    b.HasIndex("RegisteredJudgesId");
            ...
            modelBuilder.Entity("SEAL.NET.Models.Entities.MentorAssignment", b =>
                {
                    ...
                    b.HasIndex("MentorUserId", "RoundId", "TeamId")
                        .IsUnique()
            ...
            modelBuilder.Entity("SEAL.NET.Models.Entities.TeamChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SEAL.NET.Models.Entities.Track", b =>
                {
                    b.Property<Guid>("TrackId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ApplicationUserEvent", b =>
                {
                    b.HasOne("SEAL.NET.Models.Entities.Event", null)
                        .WithMany()
                    ...
                    b.HasOne("SEAL.NET.Models.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("RegisteredMentorsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("ApplicationUserEvent1", b =>
                {
                    ...
                    b.HasOne("SEAL.NET.Models.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("RegisteredJudgesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("SEAL.NET.Models.Entities.Category", b =>
                {
                    ...
                    b.HasOne("SEAL.NET.Models.Entities.Track", "Track")
                        .WithMany("Categories")
            ...
            modelBuilder.Entity("SEAL.NET.Models.Entities.TeamChatMessage", b =>
                {
                    b.HasOne("SEAL.NET.Models.Entities.Document", "AttachedDocument")
                        .WithMany()
                        .HasForeignKey("DocumentId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("SEAL.NET.Models.Entities.ApplicationUser", "Sender")
                        .WithMany()
