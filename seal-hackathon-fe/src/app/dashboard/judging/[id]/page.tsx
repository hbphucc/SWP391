  ...
  if (!data) {
    return (
      <div className="empty-state">
        ...
        <div className="empty-desc">Could not load evaluation data for this submission.</div>
        <Link href="/dashboard/judging"><button className="btn btn-secondary" style={{ marginTop: "1rem" }}>← Back to Queue</button></Link>
      </div>
    );
  }
